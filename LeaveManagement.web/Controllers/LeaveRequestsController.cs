...
namespace LeaveManagement.web.Controllers
{
    ...
    public class LeaveRequestsController : Controller
    {
        ...
        public async Task<IActionResult> Create(LeaveRequestCreateVM model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    ModelState.AddModelError(string.Empty, "Either you have exceeded your allocation with this request or you don't have any allocation");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StartDate,EndDate,LeaveTypeId,DateRequested,RequestComments,Approved,Cancelled,RequestingEmployeeId,Id,DateCreated,DateDatemodified")] LeaveRequest leaveRequest)
        {
